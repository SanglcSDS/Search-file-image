...
namespace SearchImage
{
    public partial class copyFile : Form
    {
        ...
        private void btn_open_folder_file_Click(object sender, EventArgs e)
        {
            CommonOpenFileDialog dialogs = new CommonOpenFileDialog();
            dialogs.IsFolderPicker = true;
            if (dialogs.ShowDialog() == CommonFileDialogResult.Ok)
            {
                txt_copy_folder.Text = dialogs.FileName;
            }
        ...
        private void btn_copy_file_Click_1(object sender, EventArgs e)
        {
            worker.RunWorkerAsync();
        }

        private void copyFile_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            if (worker.IsBusy)
            {
